...
In this section, I'm going to show you some IDEs that have abilities of intelligent completion and auto-format. There are all cross-platform, so the steps I show you should not be very different.
...
- Compile environment
	Switch configuration in LiteIDE depends on your operating system.
...
1. Press Ctrl+` open command tool, input following command.
	...
	Restart when installation finished. Then you can find `Package Control` item in the Preferences.
